  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      {cartProducts.map((item) => (
        <div key={item.id} className="flex items-center justify-between bg-white shadow-md rounded-lg p-4">
          ...
          <div className="flex items-center space-x-2">
            <button
              className="px-3 py-1 bg-gray-200 rounded-full text-sm text-gray-600 hover:bg-gray-300"
            ...
            <button
              className="px-3 py-1 bg-green-200 rounded-full text-sm text-green-600 hover:bg-green-300"
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <Button className="px-6 py-2 text-white text-lg font-semibold rounded-lg">Checkout</Button>
      </div>
    </div>
  );
};
