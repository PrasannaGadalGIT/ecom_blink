...
function App() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(180deg, rgba(18,9,121,1) 11%, rgba(0,0,0,1) 50%, rgba(0,0,0,1) 100%)",
      }}
    >
      <div ref={heroRef}>
        <motion.div
      ...
      <div className="py-20 px-4 max-w-7xl mx-auto">
        <h2 className="text-4xl font-bold text-center mb-16 text-blue-100">
      ...
      {/* Demo Section */}
      <div className="bg-blue-900/50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-blue-800/50 backdrop-blur-sm p-8 rounded-2xl border border-blue-500/20 shadow-xl"
          >
